...
/**
 * Customer-like second HTTPS transaction.
 * Sends a Zephyr http_client POST after bootstrap so the app exercises two
 * consecutive HTTPS requests before MQTT, matching the customer flow.
 *
 * @return 0 on transport success, negative errno-style value on transport failure
 */
